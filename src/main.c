...
/* Print usage inforamtion and exit. If IS_ERROR is nonzero, write to
    ...
    switch(next_option) {
      ...
      case 'm':
        /* User specified -m or --module-dir. */
        {
          ...
          /* Make sue that it is a directory. */
      ...
      case 'p':
        /* User specified -p or --port. */
        {
          ...
          if (*end != '\0') {
            /* The use specified nondigits in th eport number. */
            print_usage(1);
          }
